...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewHolder.cb_nivelBateria = findViewById(R.id.cn_nivelBateria);
    ...
    private void AtualizarHora() {
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                String horasMinutosFormatado = String.format("%02d:%02d", calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE));
                ...
                mViewHolder.tv_segundos.setText(segundosFormatado);
    ...
    private static class ViewHolder{
        TextView tv_horasMinutos, tv_segundos;
